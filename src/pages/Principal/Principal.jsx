  ...
  return (
    ...
    >
      <div className="w-full h-full flex flex-col justify-center items-center bg-gradient-to-r from-transparent to-black">
          <div className="max-w-[400px] md:w-[500px] h-[300px] md:h-[500px] flex flex-col justify-center items-center text-center text-[#F2F2F2] text-5xl md:text-8xl font-bold text-center z-10 gap-6">
